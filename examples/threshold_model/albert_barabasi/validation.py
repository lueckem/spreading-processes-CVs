...
def build_level_sets():
    ...
    with open("data/cv_degree_weighted.pkl", "rb") as file:
        cv = pickle.load(file)
    ...
    x[0, idx_sorted_ascending[int((1 - share_1) * params.num_agents) :]] = 1
    x[1, idx_sorted_ascending[: int(share_1 * params.num_agents)]] = 1
