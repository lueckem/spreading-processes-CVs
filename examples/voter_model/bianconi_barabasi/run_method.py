...
from sponet.network_generator import BianconiBarabasiGenerator
import numpy as np
...
def setup_params():
    ...
    print(f"Constructing Bianconi-Barabasi with {num_agents} nodes...")
    network = BianconiBarabasiGenerator(num_agents, 3, 5)()
...
def sample_anchors_and_cnvm():
    ...
    # fig, ax = plt.subplots()
    # ax = plot_trajectories(params, 100, cv, ax)
    # plt.show()
